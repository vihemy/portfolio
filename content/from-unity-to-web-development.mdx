...
With a background in developing interactive experiences for exhibitions, I’ve spent a lot of time building Unity applications in site-specific contexts. But recently, I’ve ventured into the world of web development to reach a wider user base.
